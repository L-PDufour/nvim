...
-- In lua/config/mini.lua or wherever you configure mini.pick

require("mini.pick").setup({
	window = {
		config = {
			-- Bottom of screen, wide window
